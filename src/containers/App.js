    ...
    <div className='App'>
      ...
      <div style={{ height: '50vh', width: '80vw' }}>
        ...
        <span>
          ...
          <button onClick={handleChartPreview} style={{ marginLeft: '1rem' }}>
            Preview{' '}
          </button>
        </span>
